...
use crate::{frost, CryptoRng, Error, Identifier, RngCore, Secp256K1Sha256TR };

type ReshareSecretShare = frost_core::keys::reshare::ReshareSecretShare<Secp256K1Sha256TR>;
